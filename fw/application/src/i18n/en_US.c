...
const char * const lang_en_US[_L_COUNT] = {
    ...
    [_L_FAILED] = "Failed",
    [_L_BYTES] = "Bytes",
    [_L_APP_AMIIBO] = "Emulator",
    [_L_APP_AMIIBOLINK] = "AmiiLink",
    ...
    [_L_2MIN] = "2 Minutes",
    [_L_3MIN] = "3 Minutes",
    [_L_AMIIBO_KEY_UNLOADED] = "Key not loaded",
